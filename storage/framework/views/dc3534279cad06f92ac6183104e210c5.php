                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->petID); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->cusID); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($pet->petName); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <?php if($pet->petPhoto): ?>
                                            <a href="<?php echo e(asset('storage/' . $pet->petPhoto)); ?>" target="_blank" class="text-blue-600 hover:underline">
                                                View Photo
                                            </a>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->petType); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->breed); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->gender); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($pet->birthdate ? \Carbon\Carbon::parse($pet->birthdate)->format('Y-m-d') : 'N/A'); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($pet->weightSize); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <?php if($pet->vaccinationFile): ?>
                                            <a href="<?php echo e(asset('storage/' . $pet->vaccinationFile)); ?>" target="_blank" class="text-blue-600 hover:underline">
                                                View File
                                            </a>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex gap-2">
                                            ...
                                            <form action="<?php echo e(route('pets.destroy', $pet->petID)); ?>" method="POST" class="inline"
...
<?php endif; ?>
<?php /**PATH C:\Users\Administrator\Downloads\PETHOTELFORIT6-main\resources\views/pets/admin-index.blade.php ENDPATH**/ ?>