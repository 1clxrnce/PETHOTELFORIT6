    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="text-sm text-gray-600">
                Welcome back, <span class="font-semibold">{{ auth()->user()->username }}</span>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-blue-600">{{ \App\Models\Customer::count() }}</p>
                        </div>
                        <div class="text-4xl text-blue-500">👥</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('customers.index') }}" class="text-blue-600 hover:text-blue-800 font-semibold text-sm">
                            Manage Customers →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-orange-600">{{ \App\Models\Booking::count() }}</p>
                        </div>
                        <div class="text-4xl text-orange-500">📅</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('bookings.index') }}" class="text-orange-600 hover:text-orange-800 font-semibold text-sm">
                            Manage Bookings →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-purple-600">{{ \App\Models\Pet::count() }}</p>
                        </div>
                        <div class="text-4xl text-purple-500">🐾</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('pets.index') }}" class="text-purple-600 hover:text-purple-800 font-semibold text-sm">
                            Manage Pets →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600">{{ \App\Models\Room::count() }}</p>
                        </div>
                        <div class="text-4xl text-green-500">🏠</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('rooms.index') }}" class="text-green-600 hover:text-green-800 font-semibold text-sm">
                            Manage Rooms →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-indigo-600">{{ \App\Models\Payment::count() }}</p>
                        </div>
                        <div class="text-4xl text-indigo-500">💳</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('payments.index') }}" class="text-indigo-600 hover:text-indigo-800 font-semibold text-sm">
                            View Payments →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-red-600">{{ \App\Models\Employee::count() }}</p>
                        </div>
                        <div class="text-4xl text-red-500">👨‍💼</div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('employees.index') }}" class="text-red-600 hover:text-red-800 font-semibold text-sm">
                            Manage Employees →
                        </a>
                    </div>
                </div>
