                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($bookings as $booking)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $booking->pet->petName }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div>
                                            <p class="font-bold">₱{{ number_format($booking->totalAmount, 2) }}</p>
                                            <p class="text-xs text-gray-500">Remaining: ₱{{ number_format($remaining, 2) }}</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div class="w-32">
                                            <div class="flex justify-between items-center mb-1">
                                                <span class="text-xs font-semibold text-gray-600">{{ number_format($progress, 0) }}%</span>
                                            </div>
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-2 rounded-full" style="width: {{ $progress }}%"></div>
                                            </div>
                                        </div>
                                    </td>
